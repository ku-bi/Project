...
if __name__ == "__main__":
    ...
    parser.add_argument("--model_def", type=str, default="config/complex_yolov4.cfg", help="path to model definition file")
    parser.add_argument("--weights_path", type=str, default="checkpoints/yolov4_epoch-2_MAP-0.65.pth", help="path to weights file")
